import {
  CREATE_COLLECTION_FAILURE, CREATE_COLLECTION_REQUEST, CREATE_COLLECTION_SUCCESS, GET_ALL_COLLECTION_REQUEST,
...
export const collectionReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CREATE_COLLECTION_SUCCESS:
      return { ...state, isLoading: false, collection: action.payload, allCollection: [...state.allCollection, action.payload] };
